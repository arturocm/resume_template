...
aside:
  - section: contact \FA \faUser
    content: |
      345 Alejandro Magno Monterrey, NL 64610 Mexico
  - item: tel
    content: |
    	\makebox {+52 (166) 2363 2356 \FA \faPhone}
  - item: links
    content: |
      \makebox{\href{mailto:arturo.cardenas@mail.mcgill.ca}{\small arturo.cardenas@mail.mcgill.ca}}
  ...
  - section: skills \FA \faTachometer
    content: |
      ...
      \makebox{Data Visualization}
      \makebox{Business Intelligence}
      \makebox{Business Modelling}
      \makebox{Operation Research}
      \makebox{Continuous Improvement}
      \makebox{Forecasting}
      \makebox{Processes Improvement}
      \makebox{Replenishment}
      \makebox{System Dynamics}
...
main:
  ...
  - entrylist:
      ...
      - when: 2016
        ...
        desc: |
          •	Applying analytics expertise to create prediction models and develop data products
